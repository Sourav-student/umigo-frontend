      ...
      >
        ...
        <div className="p-6 text-center">
          ...
          <div className="flex space-x-3">
            ...
            <button
              onClick={handleChat}
              className="flex-1 py-2 px-4 bg-white text-gray-700 border border-gray-300 rounded-lg font-medium hover:bg-gray-50 transition-colors flex items-center justify-center"
            >
