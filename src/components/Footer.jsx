...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    {
      name: 'LinkedIn',
      url: 'https://linkedin.com/company/umigo',
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
    ...
    <footer className="bg-gray-800 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="flex space-x-4">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="text-gray-400 hover:text-primary transform hover:scale-110 transition-all duration-200"
          ...
          {/* Quick Links */}
          <div>
            <h4 className="heading-secondary text-lg mb-4">Quick Links</h4>
            <ul className="space-y-2">
              <li>
                <Link
                  to="/"
                  className="body-text text-gray-300 hover:text-primary transition-colors duration-200"
                >
                  Home
                </Link>
              </li>
          ...
          {/* Legal Links */}
          <div>
            <h4 className="heading-secondary text-lg mb-4">Legal</h4>
            <ul className="space-y-2">
              <li>
                <a
                  href="/privacy-policy"
        ...
        <div className="border-t border-gray-700 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6 mt-4 md:mt-0">
              <a
                href="/privacy-policy"
                className="body-text text-gray-400 hover:text-primary transition-colors duration-200 text-sm"
              >
                Privacy Policy
              </a>
              <a
